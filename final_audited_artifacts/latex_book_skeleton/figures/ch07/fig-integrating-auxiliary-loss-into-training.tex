...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 7.3: Integrating auxiliary loss into training};
\end{tikzpicture}
\caption{Loss composition diagram from logits and router statistics to total loss.}
