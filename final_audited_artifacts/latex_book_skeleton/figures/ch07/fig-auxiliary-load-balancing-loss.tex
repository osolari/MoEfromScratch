...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 7.2: Auxiliary load-balancing loss};
\end{tikzpicture}
\caption{Two bars per expert: selected load and router probability mass.}
