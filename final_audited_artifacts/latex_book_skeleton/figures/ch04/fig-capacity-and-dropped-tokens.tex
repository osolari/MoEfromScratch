...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 4.4: Capacity and dropped tokens};
\end{tikzpicture}
\caption{Overloaded expert bucket with accepted and dropped token slots.}
