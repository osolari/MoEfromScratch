...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 4.3: Dispatching tokens to selected experts};
\end{tikzpicture}
\caption{Gather tokens into expert batches, process, then scatter back.}
