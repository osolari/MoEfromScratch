...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 4.2: Assignment masks and expert buckets};
\end{tikzpicture}
\caption{Assignment mask as a sparse N by E matrix and as expert buckets.}
