...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 4.1: Why top-1 routing is the simplest sparse case};
\end{tikzpicture}
\caption{Token rows each connected to one selected expert.}
