...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 2.3: Causal self-attention as the context path};
\end{tikzpicture}
\caption{Causal mask applied to attention scores before softmax.}
