...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 2.2: Token and position embeddings};
\end{tikzpicture}
\caption{Token IDs and position IDs summed into the model input tensor.}
