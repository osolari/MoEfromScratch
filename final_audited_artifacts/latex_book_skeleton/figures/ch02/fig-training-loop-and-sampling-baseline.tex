...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 2.5: Training loop and sampling baseline};
\end{tikzpicture}
\caption{Training loop pipeline: batch, forward, loss, backward, optimizer, sample.}
