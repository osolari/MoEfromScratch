...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 6.3: Capacity factors and overflow policy};
\end{tikzpicture}
\caption{Capacity slots per expert with accepted, padded, and overflow routes.}
