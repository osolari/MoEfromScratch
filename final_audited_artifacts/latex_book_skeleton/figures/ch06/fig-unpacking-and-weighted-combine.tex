...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 6.4: Unpacking and weighted combine};
\end{tikzpicture}
\caption{Expert outputs unpacked through token and slot indices into routed-out.}
