...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 6.5: Equivalence tests against the naive layer};
\end{tikzpicture}
\caption{Two implementation paths producing matching output tensors.}
