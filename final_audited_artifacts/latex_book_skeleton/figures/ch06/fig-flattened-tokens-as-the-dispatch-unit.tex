...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 6.1: Flattened tokens as the dispatch unit};
\end{tikzpicture}
\caption{Batch-sequence grid flattened into a token table for routing.}
