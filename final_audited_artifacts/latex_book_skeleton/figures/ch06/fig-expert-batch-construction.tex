...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 6.2: Expert batch construction};
\end{tikzpicture}
\caption{Sparse token assignments packed into a fixed-size expert batch grid.}
