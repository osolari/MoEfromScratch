...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 3.4: Naive token-by-token dispatch};
\end{tikzpicture}
\caption{Loop-based dispatch arrows from token rows to selected expert calls.}
