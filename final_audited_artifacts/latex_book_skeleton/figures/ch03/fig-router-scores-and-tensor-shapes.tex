...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 3.2: Router scores and tensor shapes};
\end{tikzpicture}
\caption{Flattened token matrix multiplied by a router projection to produce an N by E score table.}
