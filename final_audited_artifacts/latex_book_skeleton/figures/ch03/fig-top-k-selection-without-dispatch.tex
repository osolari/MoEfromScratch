...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 3.3: Top-k selection without dispatch};
\end{tikzpicture}
\caption{Score matrix with the top-k entries highlighted in each row.}
