...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 3.5: Shape and gradient checks};
\end{tikzpicture}
\caption{Gradient flow diagram from loss through combine weights into router and selected experts.}
