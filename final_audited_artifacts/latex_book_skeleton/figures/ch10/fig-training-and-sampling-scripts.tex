...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 10.4: Training and sampling scripts};
\end{tikzpicture}
\caption{Script workflow from config to training to checkpoint to sample text.}
