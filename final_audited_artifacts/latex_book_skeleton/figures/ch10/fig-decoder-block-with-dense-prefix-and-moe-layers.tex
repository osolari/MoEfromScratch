...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 10.2: Decoder block with dense prefix and MoE layers};
\end{tikzpicture}
\caption{Stack of decoder blocks showing dense prefix and repeated MoE layers.}
