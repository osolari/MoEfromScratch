...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 10.1: Configuration objects and model variants};
\end{tikzpicture}
\caption{Configuration tree controlling attention, FFN/MoE, routing, balancing, and diagnostics.}
