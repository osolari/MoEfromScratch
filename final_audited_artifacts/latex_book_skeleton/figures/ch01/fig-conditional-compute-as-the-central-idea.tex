...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 1.2: Conditional compute as the central idea};
\end{tikzpicture}
\caption{Tokens split through a router into a sparse subset of experts, then recombine.}
