...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 1.1: The dense FFN bottleneck};
\end{tikzpicture}
\caption{Dense decoder block with the FFN path highlighted as the always-on compute region.}
