...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 1.3: A tiny routing story};
\end{tikzpicture}
\caption{A storyboard of router scores, selected experts, expert outputs, and weighted combine.}
