...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 1.6: Chapter summary and handoff};
\end{tikzpicture}
\caption{Concept map linking tokens, router scores, top-k experts, gates, and combined output.}
