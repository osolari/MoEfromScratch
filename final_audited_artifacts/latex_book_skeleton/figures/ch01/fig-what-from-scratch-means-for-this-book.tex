...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 1.4: What from scratch means for this book};
\end{tikzpicture}
\caption{Layered build approach from scalar example to vectorized PyTorch to training script.}
