...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 12.2: Batching routed tokens at inference};
\end{tikzpicture}
\caption{Inference batch tokens packed into expert-specific microbatches.}
