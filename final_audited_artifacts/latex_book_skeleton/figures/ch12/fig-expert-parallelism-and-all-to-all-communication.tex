...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 12.4: Expert parallelism and all-to-all communication};
\end{tikzpicture}
\caption{Tokens routed across devices through an all-to-all exchange, expert compute, and return exchange.}
