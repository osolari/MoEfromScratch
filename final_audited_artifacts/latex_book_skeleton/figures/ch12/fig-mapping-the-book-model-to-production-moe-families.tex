...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 12.5: Mapping the book model to production MoE families};
\end{tikzpicture}
\caption{Concept map from book components to larger MoE system components.}
