...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 12.6: Book summary and next steps};
\end{tikzpicture}
\caption{Complete route-execute-combine summary diagram with training and inference diagnostics around it.}
