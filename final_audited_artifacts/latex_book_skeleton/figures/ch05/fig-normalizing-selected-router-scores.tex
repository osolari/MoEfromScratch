...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 5.2: Normalizing selected router scores};
\end{tikzpicture}
\caption{Top-2 score row transformed into a two-weight gate vector.}
