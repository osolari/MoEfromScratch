...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 5.3: Dispatch for two expert paths per token};
\end{tikzpicture}
\caption{Two paths per token gathered into expert batches and accumulated back.}
