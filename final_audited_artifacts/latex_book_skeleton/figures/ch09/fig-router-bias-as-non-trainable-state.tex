...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 9.2: Router bias as non-trainable state};
\end{tikzpicture}
\caption{Bias vector nudging the score table before top-k selection.}
