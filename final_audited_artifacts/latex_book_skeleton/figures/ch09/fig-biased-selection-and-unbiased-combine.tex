...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 9.3: Biased selection and unbiased combine};
\end{tikzpicture}
\caption{Two score streams: biased scores for top-k, unbiased scores for gate normalization.}
