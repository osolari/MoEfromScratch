...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 9.1: The limitation of auxiliary balancing};
\end{tikzpicture}
\caption{Auxiliary loss path entering the optimization objective beside LM loss.}
