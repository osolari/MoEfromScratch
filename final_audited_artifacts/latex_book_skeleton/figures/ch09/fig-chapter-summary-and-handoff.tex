...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 9.6: Chapter summary and handoff};
\end{tikzpicture}
\caption{Final router contract diagram with selection and combine paths separated.}
