...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 8.3: The MiniDeepSeekMoE layer contract};
\end{tikzpicture}
\caption{MiniDeepSeekMoE layer block with router, routed experts, shared experts, combine, and residual output.}
