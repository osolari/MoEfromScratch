...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 8.6: Chapter summary and handoff};
\end{tikzpicture}
\caption{Completed MiniDeepSeekMoE layer with diagnostic outputs attached.}
