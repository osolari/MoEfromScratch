...
\begin{tikzpicture}[node distance=8mm]
  ...
  \node[align=center, text=BookDeepBlue] at (4.8,-2.0) {Ch. 11.6: Chapter summary and handoff};
\end{tikzpicture}
\caption{Experiment report card combining loss, active parameters, expert balance, and routing trace.}
