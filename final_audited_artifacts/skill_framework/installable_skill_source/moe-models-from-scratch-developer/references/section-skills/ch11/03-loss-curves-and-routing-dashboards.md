---
name: moe-ch11-s03-loss-curves-and-routing-dashboards
description: use when developing section 11.3, loss curves and routing dashboards, for the latex-first book moe models from scratch. triggers include drafting this section, replacing its artifact wrappers, updating its local code, running its diagnostic, or proofreading its handoff.
---

# Section developer: Chapter 11.3 - Loss curves and routing dashboards
...
Develop only Section 11.3 of *MoE Models from Scratch*: **Loss curves and routing dashboards**.

- Chapter: 11. Training, diagnostics, and controlled experiments
- Target section file: `latex_book_skeleton/chapters/ch11/sections/03-loss-curves-and-routing-dashboards.tex`
- Planned figure wrapper: `latex_book_skeleton/figures/ch11/fig-loss-curves-and-routing-dashboards.tex`
- Planned table wrapper: `latex_book_skeleton/tables/ch11/tab-loss-curves-and-routing-dashboards.tex`
- Planned equation wrapper: `latex_book_skeleton/equations/ch11/eq-loss-curves-and-routing-dashboards.tex`
- Planned listing wrapper: `latex_book_skeleton/listings/ch11/lst-loss-curves-and-routing-dashboards.tex`
- Required diagnostic: Save dashboard figures through LaTeX wrappers, never raw includegraphics in prose.
...
```text
Develop Section 11.3, "Loss curves and routing dashboards", for MoE Models from Scratch. Use this skill markdown as the complete handoff. Produce LaTeX-first section prose, update only the artifact wrappers listed here, preserve every artifact through \input, and include a runnable or near-runnable diagnostic tied to the planned code path.
```
