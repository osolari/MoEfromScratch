---
name: moe-ch04-s03-dispatching-tokens-to-selected-experts
description: use when developing section 4.3, dispatching tokens to selected experts, for the latex-first book moe models from scratch. triggers include drafting this section, replacing its artifact wrappers, updating its local code, running its diagnostic, or proofreading its handoff.
---

# Section developer: Chapter 4.3 - Dispatching tokens to selected experts
...
Develop only Section 4.3 of *MoE Models from Scratch*: **Dispatching tokens to selected experts**.

- Chapter: 4. Top-1 routing and Switch-style dispatch
- Target section file: `latex_book_skeleton/chapters/ch04/sections/03-dispatching-tokens-to-selected-experts.tex`
- Planned figure wrapper: `latex_book_skeleton/figures/ch04/fig-dispatching-tokens-to-selected-experts.tex`
- Planned table wrapper: `latex_book_skeleton/tables/ch04/tab-dispatching-tokens-to-selected-experts.tex`
- Planned equation wrapper: `latex_book_skeleton/equations/ch04/eq-dispatching-tokens-to-selected-experts.tex`
- Planned listing wrapper: `latex_book_skeleton/listings/ch04/lst-dispatching-tokens-to-selected-experts.tex`
- Required diagnostic: Assert output rows return to the original token order.
...
```text
Develop Section 4.3, "Dispatching tokens to selected experts", for MoE Models from Scratch. Use this skill markdown as the complete handoff. Produce LaTeX-first section prose, update only the artifact wrappers listed here, preserve every artifact through \input, and include a runnable or near-runnable diagnostic tied to the planned code path.
```

## Source session starter

# Session starter: Chapter 4.3 - Dispatching tokens to selected experts

Develop only Chapter 4.3, **Dispatching tokens to selected experts**, for *MoE Models from Scratch*.

Use the detailed brief at:

`section_development_briefs/ch04/03-dispatching-tokens-to-selected-experts.md`

Must produce LaTeX section prose at:

`latex_book_skeleton/chapters/ch04/sections/03-dispatching-tokens-to-selected-experts.tex`
