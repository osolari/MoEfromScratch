---
name: moe-ch10-s04-training-and-sampling-scripts
description: use when developing section 10.4, training and sampling scripts, for the latex-first book moe models from scratch. triggers include drafting this section, replacing its artifact wrappers, updating its local code, running its diagnostic, or proofreading its handoff.
---

# Section developer: Chapter 10.4 - Training and sampling scripts
...
Develop only Section 10.4 of *MoE Models from Scratch*: **Training and sampling scripts**.

- Chapter: 10. Assembling MiniDeepSeekMoE end to end
- Target section file: `latex_book_skeleton/chapters/ch10/sections/04-training-and-sampling-scripts.tex`
- Planned figure wrapper: `latex_book_skeleton/figures/ch10/fig-training-and-sampling-scripts.tex`
- Planned table wrapper: `latex_book_skeleton/tables/ch10/tab-training-and-sampling-scripts.tex`
- Planned equation wrapper: `latex_book_skeleton/equations/ch10/eq-training-and-sampling-scripts.tex`
- Planned listing wrapper: `latex_book_skeleton/listings/ch10/lst-training-and-sampling-scripts.tex`
- Required diagnostic: Verify checkpoint reload produces logits of the same shape.
...
```text
Develop Section 10.4, "Training and sampling scripts", for MoE Models from Scratch. Use this skill markdown as the complete handoff. Produce LaTeX-first section prose, update only the artifact wrappers listed here, preserve every artifact through \input, and include a runnable or near-runnable diagnostic tied to the planned code path.
```
