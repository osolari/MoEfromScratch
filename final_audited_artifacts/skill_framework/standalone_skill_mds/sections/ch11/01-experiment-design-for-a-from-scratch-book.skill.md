---
name: moe-ch11-s01-experiment-design-for-a-from-scratch-book
description: use when developing section 11.1, experiment design for a from-scratch book, for the latex-first book moe models from scratch. triggers include drafting this section, replacing its artifact wrappers, updating its local code, running its diagnostic, or proofreading its handoff.
---

# Section developer: Chapter 11.1 - Experiment design for a from-scratch book
...
Develop only Section 11.1 of *MoE Models from Scratch*: **Experiment design for a from-scratch book**.

- Chapter: 11. Training, diagnostics, and controlled experiments
- Target section file: `latex_book_skeleton/chapters/ch11/sections/01-experiment-design-for-a-from-scratch-book.tex`
- Planned figure wrapper: `latex_book_skeleton/figures/ch11/fig-experiment-design-for-a-from-scratch-book.tex`
- Planned table wrapper: `latex_book_skeleton/tables/ch11/tab-experiment-design-for-a-from-scratch-book.tex`
- Planned equation wrapper: `latex_book_skeleton/equations/ch11/eq-experiment-design-for-a-from-scratch-book.tex`
- Planned listing wrapper: `latex_book_skeleton/listings/ch11/lst-experiment-design-for-a-from-scratch-book.tex`
- Required diagnostic: Check that every experiment saves config, seed, logs, and git/code snapshot note.
...
```text
Develop Section 11.1, "Experiment design for a from-scratch book", for MoE Models from Scratch. Use this skill markdown as the complete handoff. Produce LaTeX-first section prose, update only the artifact wrappers listed here, preserve every artifact through \input, and include a runnable or near-runnable diagnostic tied to the planned code path.
```
